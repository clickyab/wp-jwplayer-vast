...
**NEW ON THIS VERSION!**
* When the file extension is missing or not recognized, now you can force a media type with a simple tool
* The plugin is now Google Analytics ready
* Now you can call videos from outside of the loop, by indicating the post/ page id into the shortcode ([jw7-video p="123"])
* Use the [jw7-video] shortcode into the text widget
* (Premium) Choose where the logo has to be visualized into the player
* (Premium) Now you can add subtitles to your videos
...
<strong>From WordPress.org or clickyab.com</strong>
<ul>
